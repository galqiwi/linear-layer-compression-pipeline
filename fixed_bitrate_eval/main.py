...
def main():
    ...
    if torch.cuda.device_count() > 1:
        ...
        device_map = accelerate.infer_auto_device_map(model, max_memory={device_idx: "30GB" for device_idx in range(n_devices)}, no_split_module_classes=['LlamaDecoderLayer'])
