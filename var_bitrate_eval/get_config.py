...
def get_grids():
    grids = literal_eval(requests.get(
        'https://gist.githubusercontent.com/galqiwi/e428cf672253c5e19cd9cf994fae6580/raw/f2d47352e70e6b601536fec9bde9d6ce41255bbd/GRIDS_MSE_WITH_KERNELS_2024_10_19_2_BITS'
    ).text)
